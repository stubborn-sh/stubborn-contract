...
public class JsonPath {
	...
	/**
	 * Returns a builder of {@link JsonVerifiable} with which you can build your JSON
	 * Path. Once finished just call {@link JsonVerifiable#jsonPath()} to get JSON Path as
	 * String.
	 */
