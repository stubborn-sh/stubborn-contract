...
public interface JsonVerifiable extends IteratingOverArray, JsonReader {
	...
	/**
	 * Field assertions. Traverses through the list of fields and adds a JSON Path entry
	 * for each one.
	 */
	...
	/**
	 * Calling this method will setup the fluent interface to ignore any JSON Path
	 * verification
	 */
