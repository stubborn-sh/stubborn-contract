...
You must also provide consumer code that has Stubborn Contract Stub Runner set up. For
...
xref:../getting-started/first-application.adoc[Developing Your First Stubborn Contract based application],
