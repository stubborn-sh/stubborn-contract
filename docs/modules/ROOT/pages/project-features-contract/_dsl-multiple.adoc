...
.Groovy
----
include::{plugins_path}/stubborn-maven-plugin/src/test/projects/multiple-contracts/src/test/resources/contracts/com/hello/v1/WithList.groovy[lines=18..-1,indent=0]
----
...
----
package sh.stubborn.contract.verifier.tests.com.hello;
