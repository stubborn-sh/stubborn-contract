...
= How Can I Generate YAML, or X files from Stubborn Contract Contracts?

include::partial$_attributes.adoc[]

Stubborn Contract comes with a `ToFileContractsTransformer` class that lets you dump
...
After calling the transformer, the Stubborn Contract files are processed and,
