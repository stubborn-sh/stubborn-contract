...
Stubborn Contract works great in a polyglot environment. This project has a lot of
really interesting features. Quite a few of these features definitely make
Stubborn Contract Verifier stand out on the market of Consumer Driven Contract
