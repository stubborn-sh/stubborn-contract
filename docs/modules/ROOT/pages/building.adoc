...
├── scripts
├── specs
├── stubborn-contract-dependencies
├── spring-cloud-contract-shade
├── stubborn-contract-starters
...
- `stubborn-contract-dependencies`: Contains Stubborn Contract BOM
- `spring-cloud-contract-shade`: Shaded dependencies used by the plugins
- `stubborn-contract-starters`: Contains Stubborn Contract Starters
- `spring-cloud-contract-spec`: Contains specification modules (contains concept of a Contract)
- `stubborn-contract-stub-runner`: Contains Stub Runner related modules
...
- `stubborn-contract-verifier`: Core of the `Stubborn Contract Verifier` functionality
- `stubborn-contract-wiremock`: All WireMock related functionality
