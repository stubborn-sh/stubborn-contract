...
= Introducing Stubborn Contract

include::partial$_attributes.adoc[]

Stubborn Contract moves TDD to the level of software architecture.
...
Before becoming Stubborn Contract, this project was called https://github.com/Codearte/accurest[Accurest].
...
To solve the aforementioned issues, Stubborn Contract was created. The main idea is to
...
Stubborn Contract gives you the certainty that the stubs that you use were
...
The main purposes of Stubborn Contract are:
...
By default, Stubborn Contract integrates with http://wiremock.org[Wiremock] as the HTTP server stub.

IMPORTANT: Stubborn Contract's purpose is NOT to start writing business
