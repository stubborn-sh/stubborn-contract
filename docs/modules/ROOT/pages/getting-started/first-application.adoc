...
This brief tour walks through using Stubborn Contract. It consists of the following topics:
...
The following UML diagram shows the relationship of the parts of Stubborn Contract:
...
To start working with `Stubborn Contract`, you can add the Stubborn Contract Verifier
...
To get started, add the dependency to `Stubborn Contract Stub Runner`, as follows:
...
pass the stub artifact IDs and artifact repository URL as `Stubborn Contract Stub
...
provide the `group-id` and `artifact-id` for `Stubborn Contract Stub Runner` to run
