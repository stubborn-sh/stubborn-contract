...
[source]
----
sh.stubborn.contract.spec.ContractConverter=\
sh.stubborn.contract.verifier.converter.YamlContractConverter
----
...
[source]
----
sh.stubborn.contract.verifier.builder.SingleTestGenerator=/
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-moco/src/test/groovy/org/springframework/cloud/contract/stubrunner/provider/moco/MocoHttpServerStub.groovy[indent=0,lines=16..-1]
----
...
[source]
----
sh.stubborn.contract.stubrunner.HttpServerStub=\
sh.stubborn.contract.stubrunner.provider.moco.MocoHttpServerStub
----
...
sh.stubborn.contract.stubrunner.StubDownloaderBuilder=\
