...
You can customize the Stubborn Contract Verifier by extending the DSL, as shown in
...
IMPORTANT: You can set the Stubborn Contract plugin up by setting `convertToYaml` to
