...
Stubborn Contract lets you verify applications that use messaging as a
...
use those paradigms in messaging. In addition, Stubborn Contract Verifier also
...
base class or in a static import. Stubborn Contract runs that method
...
generated tests. Otherwise, the messaging part of Stubborn Contract does not
work.
...
`sh.stubborn.contract.verifier.messaging.MessageVerifierSender` and `sh.stubborn.contract.verifier.messaging.MessageVerifierReceiver`.
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-stream/src/test/groovy/org/springframework/cloud/contract/stubrunner/messaging/stream/StreamStubRunnerSpec.groovy[tags=client_trigger,indent=0]
----
====
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-stream/src/test/groovy/org/springframework/cloud/contract/stubrunner/messaging/stream/StreamStubRunnerSpec.groovy[tags=trigger_group_artifact,indent=0]
----
====
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-stream/src/test/groovy/org/springframework/cloud/contract/stubrunner/messaging/stream/StreamStubRunnerSpec.groovy[tags=trigger_artifact,indent=0]
----
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-stream/src/test/groovy/org/springframework/cloud/contract/stubrunner/messaging/stream/StreamStubRunnerSpec.groovy[tags=trigger_all,indent=0]
----
...
Stubborn Contract Stub Runner's messaging module gives you an easy way to integrate with Apache Camel.
...
You can have both Apache Camel and Stubborn Contract Stub Runner on the classpath.
...
Stubborn Contract Stub Runner's messaging module gives you an easy way to
...
You can have both Spring Integration and Stubborn Contract Stub Runner on the
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-integration/src/test/groovy/org/springframework/cloud/contract/stubrunner/messaging/integration/IntegrationStubRunnerSpec.groovy[tags=sample_dsl,indent=0]
----
====
...
[source,xml]
----
include::{tests_path}/stubborn-stub-runner-integration/src/test/resources/integration-context.xml[lines=1;18..-1]
----
====
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-integration/src/test/groovy/org/springframework/cloud/contract/stubrunner/messaging/integration/IntegrationStubRunnerSpec.groovy[tags=client_trigger,indent=0]
----
====
...
You can have both Spring Cloud Stream and Stubborn Contract Stub Runner on the
classpath. Remember to annotate your test class with `@AutoConfigureStubRunner`.
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-stream/src/test/groovy/org/springframework/cloud/contract/stubrunner/messaging/stream/StreamStubRunnerSpec.groovy[tags=sample_dsl,indent=0]
----
====
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-stream/src/test/groovy/org/springframework/cloud/contract/stubrunner/messaging/stream/StreamStubRunnerSpec.groovy[tags=setup,indent=0]
----
====
...
[source,yaml]
----
include::{tests_path}/stubborn-stub-runner-stream/src/test/resources/application.yml[]
----
====
...
Stubborn Contract Stub Runner's messaging module provides an easy way to
...
You need to have both Spring JMS and Stubborn Contract Stub Runner on the classpath. Remember to annotate your test class
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-jms/src/test/groovy/org/springframework/cloud/contract/stubrunner/messaging/jms/JmsStubRunnerSpec.groovy[tags=sample_dsl,indent=0]
----
====
...
[source,groovy]
----
include::{tests_path}/stubborn-stub-runner-jms/src/test/groovy/org/springframework/cloud/contract/stubrunner/messaging/jms/JmsStubRunnerSpec.groovy[tags=client_trigger,indent=0]
----
====
