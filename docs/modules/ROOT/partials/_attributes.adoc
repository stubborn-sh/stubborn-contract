:sc-ext: java
:project-full-name: Stubborn Contract

// project-specific attributes
:converters_path: example$tools-src/stubborn-converters
:verifier_root_path: example$verifier-src
:contract_spec_path: example$specs-src/stubborn-contract-spec-java
:contract_spec_tests_path: example$specs-src/stubborn-contract-spec
:contract_kotlin_spec_path: example$specs-src/stubborn-contract-spec-kotlin
...
:samples_branch: main
:samples_url: https://raw.githubusercontent.com/stubborn-sh/stubborn-samples/{samples_branch}
:samples_code: https://github.com/stubborn-sh/stubborn-samples/tree/{samples_branch}
