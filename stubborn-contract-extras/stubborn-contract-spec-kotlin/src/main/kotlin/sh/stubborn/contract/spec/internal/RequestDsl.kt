...
open class RequestDsl : CommonDsl() {
    ...
    fun value(value: ClientDslProperty): DslProperty<Any> = delegate.value(value) as DslProperty<Any>

    fun v(value: ClientDslProperty): DslProperty<Any> = delegate.value(value) as DslProperty<Any>
