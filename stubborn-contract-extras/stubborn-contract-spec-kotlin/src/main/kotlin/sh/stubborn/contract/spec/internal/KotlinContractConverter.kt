 ...
 *
 * Evaluates a `.kts` contract via the JVM scripting host
 * ([kotlin.script.experimental.jvmhost.BasicJvmScriptingHost]) and extracts the returned
 * [Contract] (or collection of contracts).
 *
 * @author Tim Ysewyn
 * @since 2.2.0
 */
