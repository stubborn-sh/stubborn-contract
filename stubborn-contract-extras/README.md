...
|--------|-------------|--------|
| `stubborn-contract-spec-kotlin` | Kotlin DSL for writing contracts (`.kt` files) | Best effort |
...
- Modules in `stubborn-contract-extras/` are released on a best-effort basis alongside the core.
