...
public class StubRunnerRuleCustomPortJUnitTest {
	...
	public static StubRunnerRule rule = new StubRunnerRule().repoRoot(repoRoot())
		...
		.withPort(35465)
		.downloadStub("sh.stubborn.contract.verifier.stubs:fraudDetectionServer:35466");
	...
	public void should_start_wiremock_servers() throws Exception {
		...
		then(rule.findStubUrl("sh.stubborn.contract.verifier.stubs", "loanIssuance")).isNotNull();
		then(rule.findStubUrl("loanIssuance")).isNotNull();
		then(rule.findStubUrl("loanIssuance"))
			.isEqualTo(rule.findStubUrl("sh.stubborn.contract.verifier.stubs", "loanIssuance"));
