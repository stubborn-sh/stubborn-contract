...
public final class KafkaMessage implements ContractMessage {
	 ...
	 * @param payload the record value (may be {@code null})
	 * @param headers the record headers (a {@code null} map is treated as empty);
	 * defensively copied
	 */
	public KafkaMessage(@Nullable Object payload, @Nullable Map<String, Object> headers) {
	...
	public String toString() {
		return "KafkaMessage{payload=" + this.payload + ", headers=" + this.headers + '}';
	}
