 ...
 * URL declared via {@code spring.kafka.properties.schema.registry.url}. When using Spring
...
public final class KafkaAvroMessageVerifierSender implements MessageVerifierSender<Object> {
	 ...
	 */
	public KafkaAvroMessageVerifierSender(final KafkaTemplate<String, Object> template) {
	...
	private GenericRecord buildRecord(final Schema schema, final Object payload) {
