...
class InputTests {
	...
	void shouldSetPropertyWhenUsingDollarConvenienceMethod() {
		...
		DslProperty<?> property = input.$(input.consumer(input.regex("[0-9]{5}")));
	...
	void shouldSetPropertyWhenUsingDollarConvenienceMethodForDouble() {
		Input input = new Input();
		DslProperty<?> property = input.$(input.consumer(input.regex("[0-9]{5}").asDouble()));
	...
	void shouldSetPropertyWhenUsingDollarConvenienceMethodForShort() {
		Input input = new Input();
		DslProperty<?> property = input.$(input.consumer(input.regex("[0-9]{1}").asShort()));
		Object value = property.getServerValue();
	...
	void shouldSetPropertyWhenUsingDollarConvenienceMethodForLong() {
		Input input = new Input();
		DslProperty<?> property = input.$(input.consumer(input.regex("[0-9]{5}").asLong()));
		Object value = property.getServerValue();
	...
	void shouldSetPropertyWhenUsingDollarConvenienceMethodForInteger() {
		Input input = new Input();
		DslProperty<?> property = input.$(input.consumer(input.regex("[0-9]{5}").asInteger()));
		Object value = property.getServerValue();
	...
	void shouldSetPropertyWhenUsingDollarConvenienceMethodForFloat() {
		Input input = new Input();
		DslProperty<?> property = input.$(input.consumer(input.regex("[0-9]{5}").asFloat()));
		Object value = property.getServerValue();
	...
	void shouldSetAValueIfOnlyRegexIsPassedForClient() {
		Input input = new Input();
		DslProperty<?> property = input.value(input.consumer(input.regex("[0-9]{5}")));
