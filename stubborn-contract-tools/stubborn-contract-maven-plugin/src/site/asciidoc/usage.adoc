...
== Converting Stubborn Contract DSL into WireMock stub mappings

   mvn org.springframework.cloud:stubborn-maven-plugin:convert
...
For more information please go to the Stubborn Contract Wiki or Plugin Documentation Site.
