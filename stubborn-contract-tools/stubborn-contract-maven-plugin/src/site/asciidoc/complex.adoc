...
https://github.com/stubborn-sh/stubborn-contract/tree/main/stubborn-contract-tools/stubborn-contract-maven-plugin/src/test/projects/complex-configuration
